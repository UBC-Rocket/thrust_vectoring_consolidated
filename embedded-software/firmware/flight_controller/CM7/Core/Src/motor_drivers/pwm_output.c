/**
 * @file    pwm_output.c
 * @brief   Generic HAL-timer PWM output helper. Ported verbatim from
 *          depracated/ulysses-flight-controller/Core/Src/motor_drivers/
 *          pwm_output.c — logic is chip-agnostic, only the header's HAL
 *          include changed (STM32H5 -> STM32H7).
 *
 * UBC Rocket, 2026
 */
