 ...
 * @param byte_count Number of bytes to read from FIFO.
 * @param[out] tx_buf Buffer for SPI command.
 * @return Number of bytes in the full SPI transaction.
 */
 ...
 * @param[in] rx_buf Raw received data (2 bytes: FIFO_COUNTL, FIFO_COUNTH).
 * @param[out] count Number of bytes (or records) available in FIFO.
 * @return True if parsing successful.
 */
