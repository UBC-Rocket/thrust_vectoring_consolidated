...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    */
    ...
    handle_GPDMA1_Channel5.Init.Request = GPDMA1_REQUEST_SPI1_RX;
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM2)
  {
    ...
    handle_GPDMA2_Channel1.Init.Request = GPDMA2_REQUEST_TIM2_CH2;
    ...
    handle_GPDMA2_Channel1.Init.SrcDataWidth = DMA_SRC_DATAWIDTH_WORD;
    handle_GPDMA2_Channel1.Init.DestDataWidth = DMA_DEST_DATAWIDTH_WORD;
    ...
    __HAL_LINKDMA(htim_base, hdma[TIM_DMA_ID_CC2], handle_GPDMA2_Channel1);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PE11     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = SERVO_2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(SERVO_2_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM2)
  {
    ...
    PA3     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = ESC_1_PWM_Pin|ESC_2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    PB0     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = SERVO_1_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(SERVO_1_PWM_GPIO_Port, &GPIO_InitStruct);
