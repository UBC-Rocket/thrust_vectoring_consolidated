...
void Set_Commutation_Step(uint8_t step) {
    ...
    switch (step) {
        case 0: /* Step 1 — HinA = PWM,  LinC = ON */
        ...
        case 1: /* Step 2 — HinB = PWM,  LinC = ON */
            __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, PWM_DUTY_CYCLE);
            __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_3, 0U);
            HAL_TIM_PWM_Start   (&htim1, TIM_CHANNEL_1);        /* HinB */
            HAL_TIMEx_PWMN_Start(&htim1, TIM_CHANNEL_3);        /* LinC */
            break;

        case 2: /* Step 3 — HinB = PWM,  LinA = ON */
            __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, PWM_DUTY_CYCLE); 
        ...
        case 3: /* Step 4 — HinC = PWM,  LinA = ON */
            __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_3, PWM_DUTY_CYCLE);
            __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_2, 0U);
            HAL_TIM_PWM_Start   (&htim1, TIM_CHANNEL_3);        /* HinC */
            HAL_TIMEx_PWMN_Start(&htim1, TIM_CHANNEL_2);        /* LinA */
            break;

        case 4: /* Step 5 — HinC = PWM,  LinB = ON */
            __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_3, PWM_DUTY_CYCLE);
        ...
        case 5: /* Step 6 — HinA = PWM,  LinB = ON */
            __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_2, PWM_DUTY_CYCLE);
            __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, 0U);
            HAL_TIM_PWM_Start   (&htim1, TIM_CHANNEL_2);        /* HinA */
            HAL_TIMEx_PWMN_Start(&htim1, TIM_CHANNEL_1);        /* LinB */
