...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = PWM_Phase_A_HIN_Pin|PWM_Phase_A_LIN_Pin|GPIO_PIN_10|GPIO_PIN_11;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_TIM1;
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = PWM_Phase_C_HIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(PWM_Phase_C_HIN_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM16_MspPostInit 0 */
    ...
    */
    ...
    HAL_GPIO_Init(PWM_Servo_1_GPIO_Port, &GPIO_InitStruct);
